...
export const INTENT_SCHEMA: IntentFieldDescriptor[] = [
  ...
  { key: "redirect.ingredient_synonyms", label: "食材同义", tone: "neutral", group: "redirect",
  ...
  { key: "redirect.food_form_avoid", label: "形态拒绝", tone: "avoid", group: "redirect",
    slot_path: ["redirect", "food_form_avoid"] },
  ...
  { key: "constrain.functional", label: "功能性", tone: "neutral", group: "constrain",
    slot_path: ["constrain", "functional"], scalar: true },
