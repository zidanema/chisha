        ...
        <div className="l1-grid">
          <div className="funnel">
            <div className="funnel-title row between" style={{ marginBottom: 12 }}>
              ...
              <div
                className="seg"
                style={{ display: "inline-flex", alignItems: "center", gap: 6, width: "auto", textTransform: "none", letterSpacing: 0 }}
                data-comment-anchor="807b3cf151-div-66-15"
                title="切换条形图的横轴刻度：log = 对数（早期阶段也能看见），linear = 线性（按实际倍数缩放，后段会几乎不可见）"
              >
                <span style={{ fontFamily: "var(--mono)", fontSize: 10, color: "var(--t-3)", paddingRight: 2, textTransform: "uppercase", letterSpacing: "0.06em" }}>横轴</span>
